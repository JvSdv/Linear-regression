  ...
  (function () {
      ...
      each(
        ...
        function (dim, idx) {
          ...
          var axis = this._axesMap.set(
            dim,
            new ParallelAxis(dim, axisHelper.createScaleByModel(axisModel), [0, 0], axisModel.get("type"), axisIndex)
          );
    ...
    Parallel.prototype._makeLayoutInfo = function () {
      ...
      var axisExpandable =
        ...
        axisExpandCount > 1 &&
        axisExpandWidth > 0 &&
        layoutLength > 0; // `axisExpandWindow` is According to the coordinates of [0, axisExpandLength],
    ...
    Parallel.prototype.getSlidedAxisExpandWindow = function (point) {
      ...
      if (axisCollapseWidth) {
        ...
        delta
          ? sliderMove(delta, axisExpandWindow, extent, "all") // Avoid nonsense triger on mousemove.
          : (behavior = "none");
