...
function resetLabelForRegion(
  ...
  regionName,
  regionModel,
  mapOrGeoModel, // Exist only if `viewBuildCtx.data` exists.
...
function projectPolys(
  rings, // Polygons include exterior and interiors. Or polylines.
  createStream,
  isLine
) {
  var polygons = [];
